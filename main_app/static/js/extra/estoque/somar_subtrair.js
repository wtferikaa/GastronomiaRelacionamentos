...
function calculaPreco() {
    ...
    $('.inputValorTransformado').html('<input type="hidden" class="form-control valorTransformado" placeholder="Quantidade" value="+' + valorTransformado + '">');
